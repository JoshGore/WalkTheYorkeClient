...
const CommentForm: React.FC = () => {
  ...
  const [submitComment, { data }] = useMutation(MESSAGE_INSERT_QUERY);
  ...
  return (
    ...
    <TextField
      ...
      fullWidth
      InputProps={{
        startAdornment: isIssue && <InputAdornment position="start"><Chip label="@issue" size="small" onDelete={handleIssueDelete} /></InputAdornment>
      }}
    />
    </>
  );
